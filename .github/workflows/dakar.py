...
token = "7703530778:AAH_Fm6z9siS_iVUuiKNpgt5ZIYC7ydKCPU" 
...
<b>━━━━━━━━━━━ [  🚀 Powered By  ] ━━━━━━━━━━━</b>
<i>🔹 GalaxyCarder Checkers – Premium BIN Lookup 🔹</i>
"""
...
def channel_info(message):
    ...
    related_channels = [
        ("💎 <b>Channels List</b>", "https://t.me/nzmod980"),
        ("💬 <b>Our Chat Group</b>", "https://t.me/nzmod980"),
    ]
...
"""
    ...
    keyboard.add(
        InlineKeyboardButton("🔥 Upgrade to VIP Now", url="https://t.me/Galaxy_Carder"),
        InlineKeyboardButton("📚 View Commands", callback_data="help")
    )
    keyboard.add(
        InlineKeyboardButton("👑 Contact VIP Support", url="https://t.me/Galaxy_Carder")
    )
...
"""
    ...
    keyboard = InlineKeyboardMarkup()
    keyboard.add(
        InlineKeyboardButton("🔥 Channel", url="https://t.me/nzmod980"),
        InlineKeyboardButton("👤 Contact Owner", url="https://t.me/nzmod980")
    )
...
OWNER_LINK = "https://t.me/nzmod980"  # Change this to your Telegram link
...
owners = ["5507560276"]  # List of admin IDs
...
def send_broadcast(message):
    ...
    keyboard = InlineKeyboardMarkup()
    keyboard.add(
        InlineKeyboardButton("👑 Owner", url="https://t.me/nzmod980"),
        InlineKeyboardButton("🔥 Channel", url="https://t.me/nzmod980")
    )
...
📩 <b>Contact:</b> <a href='https://t.me/nzmod980'>@yash</a> to Buy Premium!  
...
owners = {"5507560276", "5507560276"}  # Replace with actual owner IDs
...
def main(message):
	if not is_user_allowed(message.from_user.id):
		bot.reply_to(message, "You are not authorized to use this bot. for authorization dm to @Galaxy_Carder")
		return
	dd = 0
	live = 0
	ch = 0
...
console = Console()
console.print("🔥🔥 [bold magenta]yash CARDERS[/bold magenta] 🔥🔥", style="bold yellow")
...
def send_telegram_notification(msg1):
    url = f"https://api.telegram.org/bot7703530778:AAH_Fm6z9siS_iVUuiKNpgt5ZIYC7ydKCPU/sendMessage"
